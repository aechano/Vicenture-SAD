    ...
    return (
        <div className="w-full object-cover h-screen lg:h-auto">
            ...
            <button className="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" onClick={prevSlide}>
                <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-lgu-green group-hover:bg-green-600 group-focus:ring-4 group-focus:ring-green-500 group-focus:outline-none">
                    <svg class="w-4 h-4 text-white tl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
