...
import { fileToBase64, fileToBytes } from '../../../../functionHelpers/FileConverter';
...
export default function AdminMunicipalityProfile() {
    ...
    useEffect(() => {
        ...
        resetInputFields();
        setResetFileInput(false); // Note: this will cause this useEffect to run again since there is a state change.
