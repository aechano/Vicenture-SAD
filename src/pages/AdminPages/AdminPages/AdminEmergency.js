...
export default function AdminEmergency() {
    ...
    const sendMessage = () => {
        if (alert.trim() === '' || message.trim() === '') {
            alert('Alert and Message cannot be empty');
            return;
        }

        axios.post(API.addAlert, {
            "alertTitle": alert,
    ...
    return (
        <div className="ml-10 mt-6 mb-6 w-11/12 flex-shrink-0 h-full overflow-auto" >
            ...
            <div className="pt-5 flex justify-end py-4">
                <button
                    ...
                    onClick={sendMessage}  // Call the function when the button is clicked
                >
                    Send Message
                </button>
