...
import ChipsInputComponent from '../../components/ChipsInputComponent';
import { ImEye } from 'react-icons/im'

export default function PlacesToVisit_Add() {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-20 min-h-screen">
            <div className="mx-auto flex flex-col items-center w-full max-w-7xl mb-10 border-2 border-lgu-green rounded-2xl">
                <div className="text-2xl font-bold bg-lgu-green text-white p-4 w-full rounded-tl-xl rounded-tr-xl">Add Places to Visit</div>
                <div className="w-48 h-48 border-4 border-lgu-green rounded-xl mb-2 mt-4">
                    <img src={require("./../../res/img/camera.png")} alt="Image" className="w-full h-full rounded-xl" />
                </div>
                <div className='pb-2'>
